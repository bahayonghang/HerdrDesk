...
| 8h soak | AC46 | HD-025, HD-018 | 队列与恢复政策；产品 UI `--ui` soak 已 START；8h 墙钟未满；100 次断连/切换未跑 | `not_run` |
