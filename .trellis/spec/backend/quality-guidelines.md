...
| Structure | `python scripts/validate_repository.py` | Layout, no PackageReference, UTF-8; calls `herddesk_g0.evidence` and `herddesk_g0.licensing`; `windows_verified` and `ac02_passed` stay false |
