...
| `test_hd027.py` | `Hd027ResidualTests` | `implementation/hd-027-l2.json` 保持 L2 FS/SSH/TOCTOU UNVERIFIED；AC30/AC34/G0 恒为 false；无 `main.rs`；ADR-0008 proposed；golden vector hash 与 manifest 一致 |
