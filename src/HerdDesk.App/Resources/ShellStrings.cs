...
public static class ShellStrings
{
    ...
    public const string DeviceRail = "设备与会话";
    public const string WorkspaceTree = "工作区树";
    public const string WorkspaceHeader = "工作区";
    ...
    public const string EmptyBanner = "空工作台";
    public const string ControlRequiresPane = "未选择窗格，观察与控制不可用";
    public const string ConnectUnauthorized = "未授权观察，连接服务不可用，未启动进程。";
    public const string ConnectNeedsDevice = "没有可连接的会话。请先保存设备与会话。";
    public const string Connecting = "正在连接";
    public const string Synchronizing = "正在同步";
    public const string UnreadPrefix = "未读:";
    public const string Details = "详情";
    public const string Search = "搜索";
    public const string SearchPlaceholder = "搜索名称、类型、设备";
    public const string ConnectionStatus = "连接状态";
    public const string TerminalPlaceholder =
        "终端尚未接入。选择窗格后观察，不获得控制。";
    public const string CollapseDetails = "收起详情";
    public const string ExpandDetails = "展开详情";
    public const string OpenNavigation = "打开导航";
    public const string FontFamily = "字体";
    public const string FontSize = "字号";
    public const string Zoom = "缩放";
    public const string Theme = "主题";
    public const string Save = "保存";
    public const string Discard = "放弃";
    public const string NamedSession = "命名会话";
    public const string ExplicitEndpoint = "显式端点";
    public const string HerdrPath = "本机 herdr 路径";
    public const string DeviceLabel = "设备名称";
    public const string ExportPreview = "导出预览";
    public const string ConfirmExport = "确认导出";
    public const string IndependentClient = ProductInfo.IndependentClientStatement;
    ...
    public const string Unsaved = "未保存";
    public const string SavingSettings = "正在保存";
    public const string Saved = "已保存";
    public const string ValidationFailed = "校验失败";
    public const string Testing = "正在测试";
