...
| `hd-033-l2.json` | L2/L3/L4 = `UNVERIFIED`。`github_required_check=UNVERIFIED`。L2 采集器不是 live 通过。L2 Narrator overlay 不是 AC37 或屏幕阅读器证据。L2 当前系统 DPI overlay 不是 AC38，也不是 100/150/200 矩阵。L1 P5 收口目录不能关闭产品 AC27/28/29/37/38/46。parser consumed 不是呈现。`phase_gate=not_passed`。 |
