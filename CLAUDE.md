...
| [src/HerdDesk.App](src/HerdDesk.App/CLAUDE.md) | 组合根宿主 stub + HD-011 L1 ViewModels + HD-015 L1 focus/input + HD-029 L1 文件工作区 ViewModels + HD-030 L1 AttachToAgentViewModel | 已生成 |
