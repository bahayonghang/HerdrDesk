...
| App unit | `dotnet run --project tests/Unit/HerdDesk.App.Tests --configuration Release --no-build` | HD-011 L1 shell/navigation/search/settings/diagnostics ViewModels; HD-012 L1 notification routing; HD-015 L1 terminal input/focus ViewModels; HD-016 L1 control ViewModel; HD-017 L1 resource command ViewModel; HD-018 L1 RecoveryBindings / kill ledger; HD-019 L1 Shell/Terminal composition; HD-020 L1 EditDevice ViewModel; HD-021 L1 HelperInstall ViewModel; HD-023 L1 multi-device navigation/search; HD-025 L1 PaneVisibilityCoordinator; HD-029 L1 dual-pane file workspace ViewModels; fake Store / fake file endpoints; no WinUI |
