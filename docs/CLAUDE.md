...
| [testing/performance-soak.md](testing/performance-soak.md) | HD-033 L1 收口说明加 L2 Narrator overlay 与 L2 当前系统 DPI overlay。AC27/28/29/37/38/46 为 `not_run`。Narrator overlay 不是 AC37。DPI overlay 不是 AC38，也不是 100/150/200 矩阵。不是 live soak / 输入到像素 / DPI / Narrator 通过。 |
